#!/bin/bash
# Run validation SPARQL queries against a SPARQL endpoint.
# Usage: bash validate_sparql.sh <endpoint_url>
# Example: bash validate_sparql.sh http://localhost:7878/query

set -euo pipefail

ENDPOINT="${1:?Usage: validate_sparql.sh <endpoint_url>}"
...
echo "=== INSDC-RDF Validation Queries ==="
